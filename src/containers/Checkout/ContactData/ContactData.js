...
class ContactData extends Component {
  ...
  checkValidity = (value, rules) => {
    ...
    if(rules.pattern)
      isValid = trimmedValue.match(rules.pattern) && isValid;
    return isValid;
  };
  ...
  render() {
    ...
    let form = (
      <form onSubmit={this.orderHandler}>
        ...
        {console.log(formElementsArray)}
        <Button btnType={!this.state.formIsValid ? "OrderBtnDisabled" : "OrderBtnEnabled"} disabled={!this.state.formIsValid}>
          ORDER
        </Button>
      </form>
    );
